...
"You are great person / bot!", "Start smiling!!!"]
...
async def  on_message(message):
    ...
    if msg.startswith("$new"):
        encourage_messages = msg.split("$new",1)[1]
        update_encouragements(encourage_messages)
    ...
    if msg.startswith("$responding"):
        ...
        if value.lower() == "true":
            ...
            db["responding"] = False
            await message.channel.send("Responding is (je to v hajzlu).")
